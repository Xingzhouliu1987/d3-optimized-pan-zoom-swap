...
function fastZoomPan() {
  ...
  function swap_visible(hidden_layer,notransition) {
      if(swapping || widget.svg().attr("data-layer-name")==hidden_layer || params.__hidden[hidden_layer] == null) return widget;
      ...
      */
      widget.zoom().on("zoom."+widget.id().replace("-","_"), null )
      swapping = true;
      ...
      function complete_swap(){
                     ...
                     /*
                      re-enables default zooming behavior
                     */
                     widget.zoom().on("zoom."+widget.id().replace("-","_"), zoomHandler( widget.svg ) )
                     /*
